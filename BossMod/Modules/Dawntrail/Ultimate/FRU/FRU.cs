...
{
    public static ArenaBoundsComplex BuildArena() => new([new Polygon(new(100f, 100f), 20f, 64)]) { IsCircle = true }; // 中場水晶碰撞還原時要換回全新預設場地(上游 e0beca0a2)
    private static readonly ArenaBoundsComplex arena = BuildArena();
