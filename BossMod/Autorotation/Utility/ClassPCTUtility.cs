...
public sealed class ClassPCTUtility(RotationModuleManager manager, Actor player) : RoleCasterUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.TemperaCoat).As<TemperaCoatOption>("Tempera Coat", "T.Coat", 600)
            ...
            .AddOption(TemperaCoatOption.CoatOnly, "Use Tempera Coat only; ignores Tempera Grassa (if available)", cooldown: 60, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 10)
            .AddOption(TemperaCoatOption.CoatGrassaASAP, "Use Tempera Coat + Tempera Grassa ASAP, regardless of casting & weaving", cooldown: 90, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 88)
            .AddOption(TemperaCoatOption.CoatGrassaWhenever, "Use Tempera Coat + Tempera Grassa when weaving or not casting", cooldown: 90, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 88)
