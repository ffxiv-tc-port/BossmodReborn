...
public sealed class ClassGNBUtility(RotationModuleManager manager, Actor player) : RoleTankUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Aurora).As<AuroraStrategy>("Aurora", "", 150) //60s (120s total), 18s duration, 2 charges
            ...
            .AddOption(AuroraStrategy.Force, "Use Aurora", cooldown: 60, effect: 18, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 45)
            .AddOption(AuroraStrategy.ForceHold1, "Use Aurora; Holds 1 charge for manual usage", cooldown: 60, effect: 18, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 82)
        ...
        res.Define(Track.HeartOfCorundum).As<HoCOption>("HeartOfCorundum", "HoC", 350) //25s CD, 4s duration is what we really care about
            ...
            .AddOption(HoCOption.HeartOfStone, "Use Heart of Stone", cooldown: 25, effect: 7, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 68, maxLevel: 81)
            .AddOption(HoCOption.HeartOfCorundum, "Use Heart of Corundum", cooldown: 25, effect: 4, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 82)
