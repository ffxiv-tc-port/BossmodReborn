...
public sealed class ClassASTUtility(RotationModuleManager manager, Actor player) : RoleHealerUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.AspectedHelios).As<HeliosOption>("AspectedHelios", "A.Helios", 130) //AoE 15s GCD heal/regen, 15s effect duration
            ...
            .AddOption(HeliosOption.Use, "Use Aspected Helios", cooldown: 1, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 40, maxLevel: 95)
            .AddOption(HeliosOption.UseEx, "Use Helios Conjunction", cooldown: 1, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 96)
        ...
        res.Define(Track.EarthlyStar).As<StarOption>("EarthlyStar", "E.Star", 200) //AoE GCD heal, 60s CD, 10s + 10s effect duration
            ...
            .AddOption(StarOption.Use, "Use Earthly Star", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Area, minLevel: 62)
            .AddOption(StarOption.End, "Use Stellar Detonation", cooldown: 0, effect: 1, supportedTargets: ActionTargets.Self, minLevel: 62)
        ...
        res.Define(Track.Horoscope).As<HoroscopeOption>("Horoscope", "Horo", 130) //Conditional AoE heal, 60s CD, 30s effect duration
            ...
            .AddOption(HoroscopeOption.Use, "Use Horoscope", cooldown: 60, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 76)
            .AddOption(HoroscopeOption.End, "Use Enhanced Horoscope", cooldown: 0, effect: 1, supportedTargets: ActionTargets.Self, minLevel: 76)
        ...
        res.Define(Track.Macrocosmos).As<MacrocosmosOption>("Macrocosmos", "Macro", 300) //AoE GCD heal (after damage taken), 180s CD, 15s effect duration
            ...
            .AddOption(MacrocosmosOption.Use, "Use Macrocosmos", cooldown: 180, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 90, defaultPriority: ActionQueue.Priority.ManualGCD - 1)
            .AddOption(MacrocosmosOption.End, "Use Microcosmos", cooldown: 0, effect: 1, supportedTargets: ActionTargets.Self, minLevel: 90)
