...
public sealed class ClassSCHUtility(RotationModuleManager manager, Actor player) : RoleHealerUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Succor).As<SuccorOption>("Succor", "Succor", 200)
            ...
            .AddOption(SuccorOption.Succor, "Use Succor", cooldown: 2, effect: 30, supportedTargets: ActionTargets.Self, minLevel: 35, maxLevel: 95)
            .AddOption(SuccorOption.Concitation, "Use Concitation", cooldown: 2, effect: 30, supportedTargets: ActionTargets.Self, minLevel: 96)
        ...
        res.Define(Track.SacredSoil).As<SacredSoilOption>("Sacred Soil", "S.Soil", 200)
            ...
            .AddOption(SacredSoilOption.Use, "Use Sacred Soil", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Area, minLevel: 50, maxLevel: 77)
            .AddOption(SacredSoilOption.UseEx, "Use Enhanced Sacred Soil", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Area, minLevel: 78)
        ...
        res.Define(Track.DeploymentTactics).As<DeployOption>("DeploymentTactics", "Deploy.", 150)
            ...
            .AddOption(DeployOption.Use, "Use Deployment Tactics", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 56, maxLevel: 87)
            .AddOption(DeployOption.UseEx, "Use Enhanced Deployment Tactics", cooldown: 90, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 88)
        ...
        res.Define(Track.Aetherpact).As<AetherpactOption>("Aetherpact", "A.pact", 300)
            ...
            .AddOption(AetherpactOption.Use, "Use Aetherpact", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 70)
            .AddOption(AetherpactOption.End, "End Aetherpact", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self | ActionTargets.Party, minLevel: 70)
        ...
        res.Define(Track.Recitation).As<RecitationOption>("Recitation", "Recit.", 130)
            ...
            .AddOption(RecitationOption.Use, "Use Recitation", cooldown: 90, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 74, maxLevel: 97)
            .AddOption(RecitationOption.UseEx, "Use Enhanced Recitation", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 98)
