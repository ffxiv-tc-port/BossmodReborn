...
public sealed class ClassDNCUtility(RotationModuleManager manager, Actor player) : RoleRangedUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.ShieldSamba).As<SambaOption>("Shield Samba", "S.Samba", 500)
            ...
            .AddOption(SambaOption.Use87, "Use Shield Samba (120s CD), regardless if equivalent ranged buff is already active", cooldown: 120, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 56, maxLevel: 87)
            .AddOption(SambaOption.Use87IfNotActive, "Use Shield Samba  (120s CD), unless equivalent ranged buff is already active", cooldown: 90, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 56, maxLevel: 87)
            .AddOption(SambaOption.Use88, "Use Shield Samba  (90s CD), regardless if equivalent ranged buff is already active", cooldown: 90, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 88)
            .AddOption(SambaOption.Use88IfNotActive, "Use Shield Samba  (90s CD), unless equivalent ranged buff is already active", cooldown: 90, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 88)
