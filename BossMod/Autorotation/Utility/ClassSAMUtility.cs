...
public sealed class ClassSAMUtility(RotationModuleManager manager, Actor player) : RoleMeleeUtility(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.ThirdEye).As<EyeOption>("ThirdEye", "Eye", 600)
            ...
            .AddOption(EyeOption.ThirdEye, "Use Third Eye", cooldown: 15, effect: 4, supportedTargets: ActionTargets.Self, minLevel: 6, maxLevel: 81)
            .AddOption(EyeOption.Tengentsu, "Use Tengentsu", cooldown: 15, effect: 4, supportedTargets: ActionTargets.Self, minLevel: 82)
