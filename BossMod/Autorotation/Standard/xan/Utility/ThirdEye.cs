...
public class ThirdEye(RotationModuleManager manager, Actor player) : Attackxan<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        def.Define(Track.ThirdEye).As<ThirdEyeStrategy>("ThirdEye")
            .AddOption(ThirdEyeStrategy.Automatic, "Use Third Eye ~3s before predicted damage", cooldown: 15, effect: 4)
            .AddOption(ThirdEyeStrategy.AutoMax, "Use Third Eye 4s before predicted damage", cooldown: 15, effect: 4)
