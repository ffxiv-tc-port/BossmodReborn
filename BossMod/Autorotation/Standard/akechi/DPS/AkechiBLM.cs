...
public sealed class AkechiBLM(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Thunder).As<ThunderStrategy>("Thunder", "DOT", uiPriority: 198)
            .AddOption(ThunderStrategy.Allow3, "Allow the use Thunder if target Has 3s or less remaining on DoT effect", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.Allow6, "Allow the use Thunder if target Has 6s or less remaining on DoT effect", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.Allow9, "Allow the use Thunder if target Has 9s or less remaining on DoT effect", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.AllowNoDOT, "Allow the use Thunder only if target does not have DoT effect", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.ForceAny, "Force use of best Thunder regardless of DoT effect", cooldown: 0, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.ForceST, "Force use of single-target Thunder regardless of DoT effect", cooldown: 0, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 6)
            .AddOption(ThunderStrategy.ForceAOE, "Force use of AOE Thunder regardless of DoT effect", cooldown: 0, effect: 24, supportedTargets: ActionTargets.Hostile, minLevel: 26)
            .AddOption(ThunderStrategy.Forbid, "Forbid the use of Thunder for manual or strategic usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 6)
        ...
        res.Define(Track.Ender).As<EnderStrategy>("Despair", uiPriority: 197)
            .AddOption(EnderStrategy.Automatic, "Automatically use Despair or Flare based on targets nearby", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 50)
            .AddOption(EnderStrategy.OnlyDespair, "Use Despair only, regardless of targets", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 72)
            .AddOption(EnderStrategy.OnlyFlare, "Use Flare only, regardless of targets", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 50)
            .AddOption(EnderStrategy.ForceDespair, "Force the use of Despair if possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 72)
            .AddOption(EnderStrategy.ForceFlare, "Force the use of Flare if possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 50)
            .AddAssociatedActions(AID.Despair, AID.Flare);
        res.Define(Track.Polyglot).As<PolyglotStrategy>("Polyglot", "Polyglot", uiPriority: 197)
            .AddOption(PolyglotStrategy.AutoSpendAll, "Automatically select best polyglot based on targets; Spend all Polyglots as soon as possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.AutoHold1, "Automatically select best polyglot based on targets; holds 1 for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.AutoHold2, "Automatically select best polyglot based on targets; holds 2 for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.AutoHold3, "Automatically select best polyglot based on targets; holds all Polyglots for as long as possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.XenoSpendAll, "Use Xenoglossy as Polyglot spender, regardless of targets nearby; spends all Polyglots", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(PolyglotStrategy.XenoHold1, "Use Xenoglossy as Polyglot spender, regardless of targets nearby; holds 1 Polyglot for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(PolyglotStrategy.XenoHold2, "Use Xenoglossy as Polyglot spender, regardless of targets nearby; holds 2 Polyglots for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(PolyglotStrategy.XenoHold3, "Use Xenoglossy as Polyglot spender; Holds all Polyglots for as long as possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(PolyglotStrategy.FoulSpendAll, "Use Foul as Polyglot spender, regardless of targets nearby", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.FoulHold1, "Use Foul as Polyglot spender, regardless of targets nearby; holds 1 Polyglot for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.FoulHold2, "Use Foul as Polyglot spender, regardless of targets nearby; holds 2 Polyglots for manual usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.FoulHold3, "Use Foul as Polyglot spender; Holds all Polyglots for as long as possible", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.ForceXeno, "Force use of Xenoglossy", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(PolyglotStrategy.ForceFoul, "Force use of Foul", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(PolyglotStrategy.Delay, "Delay the use of Polyglot abilities for manual or strategic usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddAssociatedActions(AID.Xenoglossy, AID.Foul);
        res.Define(Track.Manafont).As<UpgradeStrategy>("Manafont", "M.font", uiPriority: 196)
            .AddOption(UpgradeStrategy.Automatic, "Automatically use Manafont optimally", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(UpgradeStrategy.Force, "Force the use of Manafont (180s cooldown), regardless of weaving conditions", cooldown: 180, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 30, maxLevel: 83)
            .AddOption(UpgradeStrategy.ForceWeave, "Force the use of Manafont (180s cooldown) in any next possible weave slot", cooldown: 180, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 30, maxLevel: 83)
            .AddOption(UpgradeStrategy.ForceEX, "Force the use of Manafont (100s cooldown), regardless of weaving conditions", cooldown: 100, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 84)
            .AddOption(UpgradeStrategy.ForceWeaveEX, "Force the use of Manafont (100s cooldown) in any next possible weave slot", cooldown: 100, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 84)
            .AddOption(UpgradeStrategy.Delay, "Delay the use of Manafont for strategic reasons", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddAssociatedActions(AID.Manafont);
        res.Define(Track.Triplecast).As<ChargeStrategy>("T.cast", uiPriority: 195)
            .AddOption(ChargeStrategy.Automatic, "Use any charges available to maintain swift rotation by instant-casting Blizzard III after Fire Phase (e.g. Despair->Transpose->Triplecast->B3 etc.)", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(ChargeStrategy.Force, "Force the use of Triplecast; uses all charges", cooldown: 60, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(ChargeStrategy.Force1, "Force the use of Triplecast; holds one charge for manual usage", cooldown: 60, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(ChargeStrategy.ForceWeave, "Force the use of Triplecast in any next possible weave slot", cooldown: 60, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(ChargeStrategy.ForceWeave1, "Force the use of Triplecast in any next possible weave slot; holds one charge for manual usage", cooldown: 60, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(ChargeStrategy.Delay, "Delay the use of Triplecast", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddAssociatedActions(AID.Triplecast);
        res.Define(Track.Swiftcast).As<UpgradeStrategy>("Swiftcast", "S.cast", uiPriority: 194)
            .AddOption(UpgradeStrategy.Automatic, "Use Swiftcast to maintain swift rotation by instant-casting Blizzard III after Fire Phase (e.g. Despair->Transpose->Swiftcast->B3 etc.)", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 66)
            .AddOption(UpgradeStrategy.Force, "Force the use of Swiftcast (60s cooldown), regardless of weaving conditions", cooldown: 60, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 18, maxLevel: 93)
            .AddOption(UpgradeStrategy.ForceWeave, "Force the use of Swiftcast (60s cooldown) in any next possible weave slot", cooldown: 180, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 18, maxLevel: 93)
            .AddOption(UpgradeStrategy.ForceEX, "Force the use of Swiftcast (40s cooldown), regardless of weaving conditions", cooldown: 40, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 94)
            .AddOption(UpgradeStrategy.ForceWeaveEX, "Force the use of Swiftcast (40s cooldown) in any next possible weave slot", cooldown: 40, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 94)
            .AddOption(UpgradeStrategy.Delay, "Delay the use of Swiftcast for strategic reasons", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 18)
            .AddAssociatedActions(AID.Swiftcast);
        res.Define(Track.LeyLines).As<ChargeStrategy>("L.Lines", uiPriority: 196)
            .AddOption(ChargeStrategy.Automatic, "Automatically decide when to use Ley Lines", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(ChargeStrategy.Force, "Force the use of Ley Lines, regardless of weaving conditions", cooldown: 120, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(ChargeStrategy.Force1, "Force the use of Ley Lines; holds one charge for manual usage", cooldown: 120, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(ChargeStrategy.ForceWeave, "Force the use of Ley Lines in any next possible weave slot", cooldown: 120, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(ChargeStrategy.ForceWeave1, "Force the use of Ley Lines in any next possible weave slot; holds one charge for manual usage", cooldown: 120, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(ChargeStrategy.Delay, "Delay the use of Ley Lines", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 2)
