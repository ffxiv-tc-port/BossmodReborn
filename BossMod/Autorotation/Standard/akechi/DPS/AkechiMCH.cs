...
public sealed class AkechiMCH(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Heat).As<HeatOption>("Heat Option", "Heat", 198)
            ...
            .AddOption(HeatOption.OnlyHeatBlast, "Only use Heat Blast, regardless of targets", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 35)
            .AddOption(HeatOption.OnlyAutoCrossbow, "Only use Auto Crossbow, regardless of targets", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 52)
        ...
        res.Define(Track.Reassemble).As<ReassembleStrategy>("Reassemble", "R.semble", 184)
            ...
            .AddOption(ReassembleStrategy.Force, "Force use of Reassemble, regardless of weaving", cooldown: 55, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 10)
            .AddOption(ReassembleStrategy.ForceWeave, "Force use of Reassemble in next possible weave window", cooldown: 55, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 10)
        ...
        res.Define(Track.Hypercharge).As<HyperchargeStrategy>("Hypercharge", "H.charge", 190)
            ...
            .AddOption(HyperchargeStrategy.ASAP, "Use Hypercharge ASAP (if any Heat Gauge is available)", cooldown: 0, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(HyperchargeStrategy.Full, "Use Hypercharge when Heat Gauge is full (or about to be)", cooldown: 0, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 30)
        ...
        res.Define(Track.Drill).As<DrillStrategy>("Drill", "", 179)
            ...
            .AddOption(DrillStrategy.ForceDrill, "Force use of Drill", cooldown: 20, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 58)
            .AddOption(DrillStrategy.ForceBioblaster, "Force use of Bioblaster", cooldown: 20, effect: 15, supportedTargets: ActionTargets.Hostile, minLevel: 72)
        ...
        res.Define(Track.Wildfire).As<WildfireStrategy>("Wildfire", "W.fire", 183)
            ...
            .AddOption(WildfireStrategy.Force, "Force use of Wildfire, regardless of weaving", cooldown: 120, effect: 10, supportedTargets: ActionTargets.Hostile, minLevel: 45)
            .AddOption(WildfireStrategy.ForceWeave, "Force use of Wildfire in next possible weave window", cooldown: 120, effect: 10, supportedTargets: ActionTargets.Hostile, minLevel: 45)
            .AddOption(WildfireStrategy.End, "End Wildfire early with Detonator", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 45)
