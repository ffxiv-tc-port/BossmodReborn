...
public sealed class AkechiDRG(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Combo).As<SingleTargetOption>("Combo", uiPriority: 200)
            .AddOption(SingleTargetOption.FullST, "Force full single target combo if 'Force Single-Target' option in is selected")
            .AddOption(SingleTargetOption.Force123ST, "Force normal single target combo if 'Force Single-Target' option is selected")
            .AddOption(SingleTargetOption.ForceBuffsST, "Force single-target buff combo if 'Force Single-Target' option is selected");
        res.Define(Track.Dives).As<DivesStrategy>("Dives", uiPriority: 185)
            .AddOption(DivesStrategy.AllowMaxMelee, "Allow Jump, Stardiver, & Dragonfire Dive only at max melee range (within 3y)")
            .AddOption(DivesStrategy.AllowCloseMelee, "Allow Jump, Stardiver, & Dragonfire Dive only at close melee range (within 1y)")
            .AddOption(DivesStrategy.Allow, "Allow the use of Jump, Stardiver, & Dragonfire Dive at any distance")
            .AddOption(DivesStrategy.Forbid, "Forbid the use of Jump, Stardiver, & Dragonfire Dive")
        ...
        res.Define(Track.ElusiveJump).As<ElusiveDirection>("Elusive Jump", uiPriority: -1)
            ...
            .AddOption(ElusiveDirection.CharacterForward, "Jump into the direction forward of the character", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 35)
            .AddOption(ElusiveDirection.CharacterBackward, "Jump into the direction backward of the character (default)", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 35)
            .AddOption(ElusiveDirection.CameraForward, "Jump into the direction forward of the camera", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 35)
            .AddOption(ElusiveDirection.CameraBackward, "Jump into the direction backward of the camera", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Self, minLevel: 35)
            .AddAssociatedActions(AID.ElusiveJump);
        res.Define(Track.LanceCharge).As<BuffsStrategy>("Lance Charge", "L. Charge", uiPriority: 170)
            .AddOption(BuffsStrategy.Automatic, "Use Lance Charge normally")
            .AddOption(BuffsStrategy.Together, "Use Lance Charge only with Battle Litany; will delay in attempt to align itself with Battle Litany (up to 30s)", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(BuffsStrategy.RaidBuffsOnly, "Use Lance Charge only when in alignment with other raid buffs or when raid buffs are active", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(BuffsStrategy.Force, "Force Lance Charge usage", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(BuffsStrategy.ForceWeave, "Force Lance Charge usage inside the next possible weave window", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 30)
            .AddOption(BuffsStrategy.Delay, "Delay Lance Charge usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 30)
            .AddAssociatedActions(AID.LanceCharge);
        res.Define(Track.BattleLitany).As<BuffsStrategy>("BattleLitany", "B.Litany", uiPriority: 165)
            .AddOption(BuffsStrategy.Automatic, "Use Battle Litany normally")
            ...
            .AddOption(BuffsStrategy.RaidBuffsOnly, "Use Battle Litany only when in alignment with other raid buffs or when other raid buffs are active", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 52)
            .AddOption(BuffsStrategy.Force, "Force Battle Litany usage", cooldown: 180, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 52)
            .AddOption(BuffsStrategy.ForceWeave, "Force Battle Litany usage inside the next possible weave window", cooldown: 180, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 52)
            .AddOption(BuffsStrategy.Delay, "Delay Battle Litany usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 52)
            .AddAssociatedActions(AID.BattleLitany);
        res.Define(Track.LifeSurge).As<SurgeStrategy>("Life Surge", "L. Surge", uiPriority: 160)
            .AddOption(SurgeStrategy.Automatic, "Use Life Surge normally")
            .AddOption(SurgeStrategy.WhenBuffed, "Attempts to use Life Surge when under any buffs - this may be wonky to use generally; mainly for rushing use when under raidbuff(s)", cooldown: 40, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 6)
            .AddOption(SurgeStrategy.Force, "Force Life Surge usage", cooldown: 40, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 6)
            .AddOption(SurgeStrategy.ForceWeave, "Force Life Surge usage inside the next possible weave window", cooldown: 40, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 6)
            .AddOption(SurgeStrategy.ForceNextOpti, "Force Life Surge usage in next possible optimal window", cooldown: 40, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 6)
            .AddOption(SurgeStrategy.ForceNextOptiWeave, "Force Life Surge optimally inside the next possible weave window", cooldown: 40, effect: 5, supportedTargets: ActionTargets.Self, minLevel: 6)
            .AddOption(SurgeStrategy.Delay, "Delay the use of Life Surge", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 6)
        ...
        res.Define(Track.PiercingTalon).As<PiercingTalonStrategy>("Piercing Talon", "P.Talon", uiPriority: 100)
            ...
            .AddOption(PiercingTalonStrategy.Force, "Force Piercing Talon usage ASAP (even in melee range)")
            .AddOption(PiercingTalonStrategy.ForceEX, "Force Piercing Talon usage ASAP when Enhanced")
        ...
        res.Define(Track.TrueNorth).As<TrueNorthStrategy>("True North", "T.North", uiPriority: 95)
            ...
            .AddOption(TrueNorthStrategy.ASAP, "Use True North as soon as possible when out of positional", cooldown: 45, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 50)
            .AddOption(TrueNorthStrategy.Rear, "Use True North for rear positional only", cooldown: 45, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 50)
            .AddOption(TrueNorthStrategy.Flank, "Use True North for flank positional only", cooldown: 45, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 50)
            .AddOption(TrueNorthStrategy.Force, "Force True North usage", cooldown: 45, effect: 10, supportedTargets: ActionTargets.Self, minLevel: 50)
            .AddOption(TrueNorthStrategy.Delay, "Delay True North usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 50)
        ...
        res.Define(Track.DragonfireDive).As<CommonStrategy>("Dragonfire Dive", "D.Dive", uiPriority: 155)
            .AddOption(CommonStrategy.Automatic, "Use Dragonfire Dive normally")
            .AddOption(CommonStrategy.Force, "Force Dragonfire Dive usage", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 50, maxLevel: 91)
            .AddOption(CommonStrategy.ForceEX, "Force Dragonfire Dive (Grants Dragon's Flight)", cooldown: 120, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 92)
            .AddOption(CommonStrategy.ForceWeave, "Force Dragonfire Dive usage inside the next possible weave window", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Dragonfire Dive usage inside the next possible weave window (Grants Dragon's Flight)", cooldown: 120, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 92)
            .AddOption(CommonStrategy.Delay, "Delay Dragonfire Dive usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 50)
            .AddAssociatedActions(AID.DragonfireDive);
        res.Define(Track.Geirskogul).As<CommonStrategy>("Geirskogul", "Geirs.", uiPriority: 150)
            .AddOption(CommonStrategy.Automatic, "Use Geirskogul normally")
            .AddOption(CommonStrategy.Force, "Force Geirskogul usage", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60, maxLevel: 69)
            .AddOption(CommonStrategy.ForceEX, "Force Geirskogul (Grants Life of the Dragon & Nastrond Ready)", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(CommonStrategy.ForceWeave, "Force Geirskogul usage inside the next possible weave window", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Geirskogul usage inside the next possible weave window (Grants Life of the Dragon & Nastrond Ready)", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Hostile, minLevel: 70)
            .AddOption(CommonStrategy.Delay, "Delay Geirskogul usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 60)
            .AddAssociatedActions(AID.Geirskogul);
        res.Define(Track.Stardiver).As<CommonStrategy>("Stardiver", "S.diver", uiPriority: 140)
            .AddOption(CommonStrategy.Automatic, "Use Stardiver normally")
            .AddOption(CommonStrategy.Force, "Force Stardiver usage", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80, maxLevel: 99)
            .AddOption(CommonStrategy.ForceEX, "Force Stardiver (Grants Starcross Ready)", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 100)
            .AddOption(CommonStrategy.ForceWeave, "Force Stardiver usage inside the next possible weave window", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Stardiver usage inside the next possible weave window (Grants Starcross Ready)", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 100)
            .AddOption(CommonStrategy.Delay, "Delay Stardiver usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 80)
            .AddAssociatedActions(AID.Stardiver);
        res.Define(Track.Jump).As<CommonStrategy>("Jump", uiPriority: 145)
            .AddOption(CommonStrategy.Automatic, "Use Jump normally")
            .AddOption(CommonStrategy.Force, "Force Jump usage", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30, maxLevel: 67)
            .AddOption(CommonStrategy.ForceEX, "Force Jump usage (Grants Dive Ready buff)", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(CommonStrategy.ForceWeave, "Force Jump usage inside the next possible weave window", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30, maxLevel: 67)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Jump usage inside the next possible weave window (Grants Dive Ready buff)", cooldown: 30, effect: 15, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(CommonStrategy.Delay, "Delay Jump usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 30)
