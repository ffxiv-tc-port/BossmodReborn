...
public sealed class AkechiDRK(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Carve).As<CarveStrategy>("Carve & Spit / Abyssal Drain", "Carve", uiPriority: 160)
            ...
            .AddOption(CarveStrategy.ForceCarve, "Force use Carve and Spit ASAP when available", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(CarveStrategy.ForceDrain, "Force use Abyssal Drain ASAP when available", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 56)
