...
public sealed class AkechiPLD(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Atonement).As<AtonementStrategy>("Atonement", "Atones", uiPriority: 155)
            ...
            .AddOption(AtonementStrategy.ForceAtonement, "Force use of Atonement", cooldown: 0, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 76)
            .AddOption(AtonementStrategy.ForceSupplication, "Force use of Supplication", cooldown: 0, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 76)
            .AddOption(AtonementStrategy.ForceSepulchre, "Force use of Sepulchre", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 76)
            .AddOption(AtonementStrategy.Delay, "Delay use of Atonement & its combo chain", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 60)
        ...
        res.Define(Track.BladeCombo).As<BladeComboStrategy>("Blade Combo", "Blades", uiPriority: 160)
            ...
            .AddOption(BladeComboStrategy.ForceConfiteor, "Force use of Confiteor", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(BladeComboStrategy.ForceFaith, "Force use of Blade of Faith", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 90)
            .AddOption(BladeComboStrategy.ForceTruth, "Force use of Blade of Truth", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 90)
            .AddOption(BladeComboStrategy.ForceValor, "Force use of Blade of Valor", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 90)
            .AddOption(BladeComboStrategy.Delay, "Delay use of Confiteor & Blades combo chain", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 80)
        ...
        res.Define(Track.FightOrFlight).As<BuffsStrategy>("Fight or Flight", "F.Flight", uiPriority: 170)
            ...
            .AddOption(BuffsStrategy.Together, "Use Fight or Flight only with Requiescat / Imperator; will delay in attempt to align itself with Requiescat / Imperator if misaligned", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(BuffsStrategy.RaidBuffsOnly, "Use Fight or Flight only with raid buffs; will delay in attempt to align itself with raid buffs", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(BuffsStrategy.Force, "Force Fight or Flight usage", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(BuffsStrategy.ForceWeave, "Force Fight or Flight usage inside the next possible weave window", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(BuffsStrategy.Delay, "Delay Fight or Flight usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 2)
        ...
        res.Define(Track.Requiescat).As<BuffsStrategy>("Requiescat", "R.scat", uiPriority: 165)
            ...
            .AddOption(BuffsStrategy.Together, "Use Requiescat / Imperator only with Fight or Flight; will delay in attempt to align itself with Fight or Flight", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 68)
            .AddOption(BuffsStrategy.RaidBuffsOnly, "Use Requiescat / Imperator only with raid buffs; will delay in attempt to align itself with raid buffs", cooldown: 180, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 68)
            .AddOption(BuffsStrategy.Force, "Force Requiescat / Imperator usage", cooldown: 180, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 68)
            .AddOption(BuffsStrategy.ForceWeave, "Force Requiescat / Imperator usage inside the next possible weave window", cooldown: 180, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 68)
            .AddOption(BuffsStrategy.Delay, "Delay Requiescat / Imperator usage", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 68)
        ...
        res.Define(Track.GoringBlade).As<GoringBladeStrategy>("Goring Blade", "G.Blade", uiPriority: 135)
            ...
            .AddOption(GoringBladeStrategy.Early, "Use Goring Blade before spending Requiescat stacks", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(GoringBladeStrategy.Late, "Use Goring Blade after spending Requiescat stacks", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(GoringBladeStrategy.Force, "Force use of Goring Blade", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 54)
            .AddOption(GoringBladeStrategy.Delay, "Delay use of Goring Blade", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 54)
        ...
        res.Define(Track.Holy).As<HolyStrategy>("Holy Spirit / Circle", "Holy S/C", uiPriority: 150)
            ...
            .AddOption(HolyStrategy.Early, "Use best Holy action under Divine Might ASAP", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(HolyStrategy.Late, "Use best Holy action under Divine Might after Atonement combo (or if nothing else left)", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 68)
            .AddOption(HolyStrategy.OnlySpirit, "Only use Holy Spirit as optimal Holy action", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(HolyStrategy.OnlyCircle, "Only use Holy Circle as optimal Holy action", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 72)
            .AddOption(HolyStrategy.ForceSpirit, "Force use of Holy Spirit", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(HolyStrategy.ForceCircle, "Force use of Holy Circle", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 72)
            .AddOption(HolyStrategy.Delay, "Delay use of Holy actions", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 64)
        ...
        res.Define(Track.Dash).As<DashStrategy>("Intervene", "Dash", uiPriority: 95)
            ...
            .AddOption(DashStrategy.Force, "Force use of Intervene", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 66)
            .AddOption(DashStrategy.Force1, "Force use of Intervene; Hold one charge for manual usage", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 66)
            .AddOption(DashStrategy.GapClose, "Use as gap closer if outside melee range", cooldown: 30, effect: 0, supportedTargets: ActionTargets.None, minLevel: 66)
            .AddOption(DashStrategy.GapClose1, "Use as gap closer if outside melee range; Hold one charge for manual usage", cooldown: 30, effect: 0, supportedTargets: ActionTargets.None, minLevel: 66)
            .AddOption(DashStrategy.Delay, "Delay use of Intervene", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 66)
            .AddAssociatedActions(AID.Intervene);
        res.Define(Track.Ranged).As<RangedStrategy>("Ranged", "Ranged", uiPriority: 100)
            .AddOption(RangedStrategy.Automatic, "Uses Holy Spirit when standing still; Uses Shield Lob if moving")
            .AddOption(RangedStrategy.OpenerRangedCast, "Use Holy Spirit at the start of combat if outside melee range", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(RangedStrategy.OpenerCast, "Use Holy Spirit at the start of combat regardless of range", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(RangedStrategy.ForceCast, "Force use of Holy Spirit", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(RangedStrategy.RangedCast, "Use Holy Spirit for ranged attacks", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 64)
            .AddOption(RangedStrategy.OpenerRanged, "Use Shield Lob at the start of combat if outside melee range", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 15)
            .AddOption(RangedStrategy.Opener, "Use Shield Lob at the start of combat regardless of range", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 15)
            .AddOption(RangedStrategy.Force, "Force use of Shield Lob", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 15)
            .AddOption(RangedStrategy.Ranged, "Use Shield Lob for ranged attacks", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 15)
            .AddOption(RangedStrategy.Forbid, "Prohibit the use of ranged attacks", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 15)
