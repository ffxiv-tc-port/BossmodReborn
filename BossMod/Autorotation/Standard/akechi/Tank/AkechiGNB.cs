...
public sealed class AkechiGNB(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.Combo).As<ComboStrategy>("Combo", uiPriority: 200)
            .AddOption(ComboStrategy.ForceSTwithO, "if 'Force Single-Target Rotation' is selected, it will prevent overcapping cartridges with Burst Strike (if available)")
            .AddOption(ComboStrategy.ForceSTwithoutO, "if 'Force Single-Target Rotation' is selected, it will not prevent overcapping cartridges")
            .AddOption(ComboStrategy.ForceAOEwithO, "if 'Force AOE Rotation' is selected, it will prevent overcapping cartridges with Fated Circle (if available)")
            .AddOption(ComboStrategy.ForceAOEwithoutO, "if 'Force AOE Rotation' is selected, it will not prevent overcapping cartridges");
        res.Define(Track.Cartridges).As<CartridgeStrategy>("Cartridges", "Carts", uiPriority: 180)
            .AddOption(CartridgeStrategy.Automatic, "Automatically decide when to use cartridges; uses them optimally", supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.OnlyBS, "Uses Burst Strike optimally as cartridge spender only, regardless of targets", supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.OnlyFC, "Uses Fated Circle optimally as cartridge spender only, regardless of targets", supportedTargets: ActionTargets.Hostile, minLevel: 72)
            .AddOption(CartridgeStrategy.ForceBS, "Force use of Burst Strike regardless of cartridge count", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.ForceBS1, "Force use of Burst Strike when only 1 cartridge is available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.ForceBS2, "Force use of Burst Strike when only 2 cartridges are available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.ForceBS3, "Force use of Burst Strike when only 3 cartridges are available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 30)
            .AddOption(CartridgeStrategy.ForceFC, "Force use of Fated Circle when any cartridges are available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 72)
            .AddOption(CartridgeStrategy.ForceFC1, "Force use of Fated Circle when only 1 cartridge is available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 72)
            .AddOption(CartridgeStrategy.ForceFC2, "Force use of Fated Circle when only 2 cartridges are available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 72)
            .AddOption(CartridgeStrategy.ForceFC3, "Force use of Fated Circle when only 3 cartridges are available", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 72)
        ...
        res.Define(Track.NoMercy).As<NoMercyStrategy>("No Mercy", "N.Mercy", uiPriority: 160)
            ...
            .AddOption(NoMercyStrategy.Force, "Force use of No Mercy, regardless of weaving", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.ForceW, "Force use of No Mercy in next possible weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.ForceQW, "Force use of No Mercy in next possible last second weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force1, "Force use of No Mercy when only 1 cartridge is available, regardless of weaving", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force1W, "Force use of No Mercy when only 1 cartridge is available & in next weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force1QW, "Force use of No Mercy when only 1 cartridge is available & in next possible last-second weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force2, "Force use of No Mercy when only 2 cartridges are available, regardless of weaving", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force2W, "Force use of No Mercy when only 2 cartridges are available & in next possible weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force2QW, "Force use of No Mercy when only 2 cartridges are available & in next possible last-second weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force3, "Force use of No Mercy when only 3 cartridges are available, regardless of weaving", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force3W, "Force use of No Mercy when only 3 cartridges are available & in next possible weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
            .AddOption(NoMercyStrategy.Force3QW, "Force use of No Mercy when only 3 cartridges are available & in next possible last-second weave slot", cooldown: 60, effect: 20, supportedTargets: ActionTargets.Self, minLevel: 2)
        ...
        res.Define(Track.SonicBreak).As<SonicBreakStrategy>("Sonic Break", "S.Break", uiPriority: 145)
            ...
            .AddOption(SonicBreakStrategy.Force, "Force use of Sonic Break", cooldown: 0, effect: 30, supportedTargets: ActionTargets.Hostile, minLevel: 54)
        ...
        res.Define(Track.GnashingFang).As<GnashingStrategy>("Gnashing Fang", "G.Fang", uiPriority: 150)
            ...
            .AddOption(GnashingStrategy.ForceGnash, "Force use of Gnashing Fang", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.ForceGnash1, "Force use of Gnashing Fang when only 1 cartridge is available", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.ForceGnash2, "Force use of Gnashing Fang when only 2 cartridges are available", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.ForceGnash3, "Force use of Gnashing Fang when only 3 cartridges are available", cooldown: 30, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.ForceClaw, "Force use of Savage Claw", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.ForceTalon, "Force use of Wicked Talon", cooldown: 0, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 60)
            .AddOption(GnashingStrategy.Delay, "Delay use of Gnashing Fang", cooldown: 0, effect: 0, supportedTargets: ActionTargets.None, minLevel: 60)
        ...
        res.Define(Track.Bloodfest).As<BloodfestStrategy>("Bloodfest", "Fest", uiPriority: 150)
            ...
            .AddOption(BloodfestStrategy.Force, "Force use of Bloodfest, regardless of ammo count & weaving", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(BloodfestStrategy.ForceW, "Force use of Bloodfest in next possible weave slot, regardless of ammo count", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(BloodfestStrategy.Force0, "Force use of Bloodfest only if empty on cartridges", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
            .AddOption(BloodfestStrategy.Force0W, "Force use of Bloodfest only if empty on cartridges & in next possible weave slot", cooldown: 120, effect: 0, supportedTargets: ActionTargets.Hostile, minLevel: 80)
        ...
        res.Define(Track.DoubleDown).As<DoubleDownStrategy>("DoubleDown", "D.Down", uiPriority: 130)
            ...
            .AddOption(DoubleDownStrategy.Force, "Force use of Double Down regardless of cartridge count", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 90)
            .AddOption(DoubleDownStrategy.Force1, "Force use of Double Down when only 1 cartridge is available", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 90)
            .AddOption(DoubleDownStrategy.Force2, "Force use of Double Down when only 2 cartridges are available", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 90)
            .AddOption(DoubleDownStrategy.Force3, "Force use of Double Down when only 3 cartridges are available", cooldown: 60, effect: 0, supportedTargets: ActionTargets.Self, minLevel: 90)
